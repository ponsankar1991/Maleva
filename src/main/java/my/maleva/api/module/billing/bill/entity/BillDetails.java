package my.maleva.api.module.billing.bill.entity;
...
/**
 * JPA entity for BillDetails table
 */
@Entity
...
public class BillDetails {
    ...
    @Column(name = "BillMasterRefId", nullable = false)
    ...
    @Column(name = "ActualAmount1", nullable = false)
